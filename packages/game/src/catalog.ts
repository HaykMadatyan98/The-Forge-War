...
/** Mine UI branches */
export const MINE_BRANCHES = {
  metal: {
    id: 'metal',
    mine: ['copper_ore', 'iron_ore', 'coal', 'steel_ore', 'mythril_ore'],
    smelt: ['copper_bar', 'iron_bar', 'steel_bar', 'mythril_bar'],
  },
  wood: {
    id: 'wood',
    mine: ['softwood', 'hardwood', 'ashwood', 'ironwood', 'yew'],
    smelt: ['softwood_plank', 'hardwood_plank', 'ash_plank', 'ironwood_plank', 'yew_plank'],
  },
  leather: {
    id: 'leather',
    mine: ['scrap_hide', 'wolf_hide', 'boar_hide', 'bear_hide', 'wyrm_scale'],
    smelt: ['scrap_leather', 'wolf_leather', 'boar_leather', 'bear_leather', 'wyrm_leather'],
  },
};

export const FORGE_BRANCHES = ['melee', 'pole', 'ranged', 'armor'];

/** Resources unlocked at campaign start */
export const STARTER_UNLOCKED_RESOURCES = [
  'copper_ore',
  'coal',
  'softwood',
  'scrap_hide',
...
export const WEAPON_PROFILES = {
  /** No equipped weapon — melee fists, weaker than any blade. */
  unarmed: { hands: 1, rangeMin: 1, rangeMax: 1, power: 0.62, acc: 0.92, init: 1, sta: 5 },
...
export const REGIONS = [
  {
    ...
    missions: [
      ...
      },
      {
        ...
        enemies: 3,
        enemyLvl: 2,
        reward: { gold: 55, scrap_hide: 5, copper_ore: 4 },
        unlockResources: ['wolf_hide', 'iron_bar'],
      },
      {
        id: 'fields_3',
        enemies: 4,
        enemyLvl: 3,
        reward: { gold: 70, iron_ore: 4, hardwood: 3 },
        unlockResources: ['hardwood_plank', 'wolf_leather'],
      },
      {
        id: 'fields_boss',
        enemies: 5,
        enemyLvl: 4,
        boss: true,
        reward: { gold: 120, iron_ore: 8, wolf_hide: 4 },
        unlockResources: ['ashwood', 'boar_hide'],
      },
    ],
  },
  {
    ...
    missions: [
      {
        ...
        enemies: 4,
        enemyLvl: 5,
        reward: { gold: 90, hardwood: 6, ashwood: 2 },
        unlockResources: ['ash_plank', 'steel_ore'],
      },
      {
        id: 'forest_2',
        enemies: 5,
        enemyLvl: 6,
        reward: { gold: 100, wolf_hide: 5, iron_ore: 5 },
        unlockResources: ['boar_leather', 'steel_bar'],
      },
      {
        id: 'forest_3',
        enemies: 6,
        enemyLvl: 7,
        reward: { gold: 120, boar_hide: 4, coal: 6 },
        unlockResources: ['ironwood', 'bear_hide'],
      },
      {
        id: 'forest_boss',
        enemies: 7,
        enemyLvl: 8,
        boss: true,
        reward: { gold: 180, ashwood: 6, iron_bar: 2 },
        unlockResources: ['ironwood_plank', 'yew', 'mythril_ore'],
      },
    ],
  },
  {
    ...
    missions: [
      {
        ...
        enemies: 6,
        enemyLvl: 9,
        reward: { gold: 140, steel_ore: 3, ironwood: 3 },
        unlockResources: ['yew_plank', 'bear_leather'],
      },
      {
        id: 'hills_2',
        enemies: 7,
        enemyLvl: 10,
        reward: { gold: 160, bear_hide: 3, coal: 8 },
        unlockResources: ['mythril_bar', 'wyrm_scale'],
      },
      {
        id: 'hills_3',
        enemies: 8,
        enemyLvl: 11,
        reward: { gold: 180, mythril_ore: 2, yew: 2 },
        unlockResources: ['wyrm_leather'],
      },
      {
        id: 'hills_boss',
        enemies: 10,
        enemyLvl: 12,
        boss: true,
        reward: { gold: 280, mythril_ore: 4, wyrm_scale: 2 },
        unlockResources: [],
      },
    ],
  },
...
export function levelXpToNext(level) {
  // Gentler early game, steeper after 12
  const L = Math.max(1, level | 0);
  if (L <= 8) return Math.floor(28 + L * L * 5.5);
  if (L <= 16) return Math.floor(36 + L * L * 7);
  return Math.floor(50 + L * L * 9);
}
